        ...
        <h4 class="subtitle" align="center"><?php echo $title; ?></h4>
         ...
         <form action="database/db_rud_membresias.php?a=<?php echo $accion; ?>" method="POST">   
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="idMembresia"  placeholder="Ingrese el ID de la membresia" value="" >                        
            </div> 

            <div class="form-group">
                <label for="formGroupExampleInput">Tipo de membresia</label>
                <input type="text" class="form-control" name="tipoMembresia" placeholder="Ingrese el tipo de membresia" value="">
            </div> 
            <div class="form-group">
                <label for="formGroupExampleInput">Precio de la membresia</label>
                <input type="text" class="form-control" name="precioMembresia" placeholder="Ingrese el precio de la membresia" value="">
            </div> 
            <br>
