    ...
    <div class="color">
      ...
      <form action="database/db_rud_membresias.php?a=agregar" method="POST">   
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="idMemb"  placeholder="Ingrese el ID de la membresia" value="" >                                    
            </div> 

            <div class="form-group">
                <label for="formGroupExampleInput">Tipo de membresia</label>
                <input type="text" class="form-control" name="tipoMemb" placeholder="Ingrese el tipo de membresia" value="">
            </div> 
            <div class="form-group">
                <label for="formGroupExampleInput">Precio de la membresia</label>
                <input type="text" class="form-control" name="precioMemb" placeholder="Ingrese el precio de la membresia" value="">
            </div> 
            <br>
